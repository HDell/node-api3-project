exports.seed = function(knex, Promise) {
  return knex('posts').insert([
    ...
    {
      user_id: 2,
      text: "I ain't been droppin' no eaves, sir! Promise!" }, // 5
    {
      user_id: 2,
      text: "Of course you are, and I'm coming with you!" }, // 6
    {
      user_id: 2,
    ...
    {
      user_id: 3,
      text: 'Well, that rules you out, Pip.' }, // 9
    {
      user_id: 4,
      text: "We've had one yes. What about second breakfast?" }, // 10
    {
      user_id: 4,
    ...
    {
      user_id: 5,
      text: 'When in doubt, follow your nose.' }, // 16
    {
      user_id: 5,
      text: 'YOU SHALL NOT PASS!' }, // 17
    {
      user_id: 5,
      text: 'Fly you fools!' }, // 18
    {
      user_id: 5,
    ...
    {
      user_id: 8,
      text: "And I suppose you think you're the one to do it!" }, // 30
    {
      user_id: 8,
